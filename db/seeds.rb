...
Planet.create(name: 'Aleraan', type: 'Mixte', safety: 3, prix: 500, localisation: 'Centre', user_id: 1, description: "Magnifique planète des mondes du noyau, aux multiples climats et paysages. Réputée pour son vin exceptionnelle. Réductions importantes pour les jedis.")

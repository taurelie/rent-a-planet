...
hott = Planet.create!(name: 'Hott', planet_type: 'Glacée', safety: 2, prix: 600, localisation: 'Bordure Extérieure', user: padme, description: "Planète gelée du système du même nom. Les plus grands dangers : les températures et les wampas. Amateurs de ski vous serez enchantés.")
